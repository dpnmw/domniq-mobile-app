        ...
        <div class="dma-card dma-card--community">
          <div class="dma-card__body">
            ...
            <div class="dma-stats-row">
              <div class="dma-stat">
                <span class="dma-stat__value">{{@controller.computedStats.total}}</span>
                <span class="dma-stat__label">Total</span>
              </div>
              <div class="dma-stat">
                <span class="dma-stat__value">{{@controller.computedStats.ios}}</span>
                <span class="dma-stat__label">iOS</span>
              </div>
              <div class="dma-stat">
                <span class="dma-stat__value">{{@controller.computedStats.android}}</span>
                <span class="dma-stat__label">Android</span>
              </div>
            </div>
